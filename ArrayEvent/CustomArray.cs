    ...
    public class CustomArray<T> : IEnumerable<T>
    {
        ...
        public T this[int item]
        {
            ...
            set
            {
                ...
                if (item.CompareTo(value)!=0 && !array[item-first].Equals(value))
                    OnChangeElement.Invoke(this, new ArrayEventArgs<T>(item, "Value changed", value));
                else if(item.Equals(value) && !array[item - first].Equals(value))
                    OnChangeEqualElement.Invoke(this, new ArrayEventArgs<T>(item, "Value is the same as index", value));
